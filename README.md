...
The template comes pre-defined with a schema containing `Page`, `Project`, `Person`, and `Settings` document types.
...
The schema for the `Project` document type is defined in the `studio/src/schemaTypes/project.ts` file. You can [add more document types](https://www.sanity.io/docs/schema-types) to the schema to suit your needs.
