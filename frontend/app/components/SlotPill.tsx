...
export default function SlotPill({mode, isVisible, onToggleMode, onClose}: SlotPillProps) {
  ...
  return (
    <div
      className={cn(
        'absolute top-4 right-4 z-40 flex items-center rounded-full bg-pill backdrop-blur-[80px] shadow-[0_0_20px_rgba(0,0,0,0.08)] border border-border-subtle transition-all duration-300 ease-out',
        hasClose ? 'gap-3 px-4 py-2' : 'justify-center w-9 h-9',
