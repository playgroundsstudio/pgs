...
export default function GetStartedCode() {
  ...
  return (
    <div className="flex flex-col md:inline-flex md:flex-row rounded-xl md:rounded-full shadow-xl md:whitespace-nowrap text-center bg-gray-900 p-4 md:pr-2 md:pl-6 md:py-2 text-white text-sm mt-6 font-mono gap-4 items-center selection:bg-blue selection:text-white">
      ...
      >
        ...
        <span
          className={`hidden md:block absolute bottom-full left-1/2 transform -translate-x-1/2 -translate-y-4 bg-yellow text-black text-sm rounded py-2 px-4 transition-opacity duration-300 ${
