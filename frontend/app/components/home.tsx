      ...
      >
        {index > 0 && active === index && (
          <button
            ...
            className="absolute inset-0 z-20 rounded-full bg-hoverslot backdrop-blur-[10px] text-dark-1 flex items-center justify-center opacity-0 transition-opacity group-hover:opacity-100"
          >
